...
/*O algoritmo é um programa de gerenciamento de um grafo, onde o usuário pode criar, modificar e visualizar 
um grafo não direcionado por meio de um menu de opções.*/
...
// Função Principal
int main() {
    // Solicitar o número de vértices do grafo até ser válido
