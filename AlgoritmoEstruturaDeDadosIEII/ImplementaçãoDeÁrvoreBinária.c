...
/*Este código é uma implementação de uma árvore binária com funcionalidades de inserção e pesquisa de nós. 
Ele permite ao usuário criar uma árvore binária interativamente, inserindo nós com valores e especificando 
o lado (esquerda, direita ou raiz) onde cada nó deve ser inserido.*/
    ...
    do {
        ...
        switch (opt) {
            case 1:
                ...
                scanf(" %c", &pai); // Consumindo a quebra de linha anterior
                printf("Digite o valor do NO: ");
                scanf(" %c", &no);  // Consumindo a quebra de linha anterior
