...
/*Este código implementa o algoritmo de Dijkstra para encontrar o caminho mais curto em um grafo.
Ele permite criar um grafo e procurar os menores caminhos no grafo após a criação.*/
